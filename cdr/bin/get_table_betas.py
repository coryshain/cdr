...
from cdr.util import filter_models
...
if __name__ == '__main__':
    ...
    argparser.add_argument('-m', '--models', nargs='+', default=[], help='List of model names from which to extract betas. Regex permitted. If unspecified, extracts betas from all CDR models.')
